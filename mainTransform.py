...
#Creamos un Ã­ndice que nos valdrÃ¡ de identificador.
datetime_dim = datetime_dim.withColumn("datetime_id", monotonically_increasing_id())

#Dividimos el timestamp de pick y drop en sus respectivo hora, dia, mes, aÃ±o y dÃ­a de la semana creando columnas con .withColumn
...
tablesnames = [fact_table, passenger_count_dim, trip_distance_dim,rate_code_dim,datetime_dim, payment_type_dim, pickup_location_dim, drop_location_dim]
rutasnames = ['data_taxi_batch.fact_table', 'data_taxi_batch.passenger', ' data_taxi_batch.tripdistance', 'data_taxi_batch.ratecode', 'data_taxi_batch.datetime', 'data_taxi_batch.paymenttype', 'data_taxi_batch.pickuploc', 'data_taxi_batch.droploc']
